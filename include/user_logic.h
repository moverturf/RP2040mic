...
static void user_timing_and_classification(ei_impulse_result_t *result)
{
...
static int user_label_detected(ei_impulse_result_t *result) {
    return result->label_detected;
}

static void user_display_results(bool continuous_mode, ei_impulse_result_t *result)
{
